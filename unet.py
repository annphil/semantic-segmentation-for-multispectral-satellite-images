...
"""
# CHANGED
def unet_model(nb_classes=5, img_size=256, nb_channels=8, nb_filters_start=32,  
              growth_factor=2, upconv=True, droprate=0.25):
    ...
    # For binary segmentation with Dice Coefficient 
